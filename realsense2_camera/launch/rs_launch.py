...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.backlight_compensation', 'default': 'false', 'description': "''"},
                           {'name': 'rgb_camera.enable_white_balance', 'default': 'false', 'description': "''"},                          
                           {'name': 'rgb_camera.exposure',        'default': '500', 'description': "''"},
                           {'name': 'rgb_camera.gain',        'default': '64', 'description': "''"},
                           {'name': 'rgb_camera.brightness',        'default': '0', 'description': "''"},
                           {'name': 'rgb_camera.contrast',        'default': '50', 'description': "''"},
                           {'name': 'rgb_camera.gamma',        'default': '300', 'description': "''"},
                           {'name': 'rgb_camera.hue',        'default': '20', 'description': "''"},
                           {'name': 'rgb_camera.saturation',        'default': '40', 'description': "''"},
                           {'name': 'rgb_camera.sharpness',        'default': '50', 'description': "''"},
                           {'name': 'rgb_camera.white_balance',        'default': '4650', 'description': "''"},
